...
(function ($) {
    ...
    var cartData,
        ...
        orderform = '<p class="jqcart-cart-title">Контактная информация:</p><form class="jqcart-orderform"><p><label>ФИО:</label><input type="text" name="user_name"></p><p><label>Телефон:</label><input type="text" name="user_phone"></p><p><label>Email:</label><input type="email" name="user_mail"></p><p><label>Адрес:</label><input type="text" name="user_address"></p><p><label>Коментарий:</label><textarea name="user_comment"></textarea></p><p><p class="jqcart-cart-title">Оплата:</p><div style="text-align: left"><label style="margin-right: 10px;margin-bottom: 10px;"><input name="oplata" type="radio" value="Наличными" checked>Наличными</label><label style="margin-right: 10px;margin-bottom: 10px;"><input name="oplata" type="radio" value="Картой курьеру">Картой курьеру</label></div><input type="submit" value="Отправить заказ"><input type="reset" value="Вернуться к покупкам"></p></form>';
    var opts = {
        buttons: '.add_item',
        cartLabel: 'body',
        visibleLabel: false,
